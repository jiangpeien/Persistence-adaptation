...
mkdir PETRI_holiday_cluster_variant/apt_selected 
cd PETRI_holiday_cluster_variant/apt_selected 
...
BARCODE_FILE="PETRI_holiday_cluster_variant/apt_D2D4D23_barcodes.csv"
...
# Output file
output_file="PETRI_holiday_cluster_variant/apt_D2D4D23_1743889base.csv"
