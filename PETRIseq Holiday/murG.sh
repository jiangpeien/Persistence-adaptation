...
mkdir PETRI_holiday_cluster_variant/murG_selected 
cd PETRI_holiday_cluster_variant/murG_selected 
...
BARCODE_FILE="PETRI_holiday_cluster_variant/murG_D2D4D23_barcodes.csv"
...
# Output file
output_file="PETRI_holiday_cluster_variant/murG_D2D4D23_1445029base.csv"
